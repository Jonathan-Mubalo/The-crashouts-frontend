...
useEffect(()=>{ const filteredEvent = allEventsData.filter((item) => { return item["_id"] === storedEvent });
          ...
          <>
            ...
            <section className="section">
                ...
                <main className="dialog_main">
                  ...
                  <button className="mainBtn infoBtn dialogBtn" onClick={() => { navigate(-1)      }}>Go back to events</button>
                </main>
              </ section>
            </section>
          </>
